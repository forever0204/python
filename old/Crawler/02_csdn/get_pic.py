...
class BeautifulPicture():
    ...
    def __init__(self):  #类的初始化操作
        ...
        self.folder_path = 'D:\Tupian\cra'  #设置图片要存放的文件目录
    ...
    def get_pic(self):
        ...
        print('开始获取所有a标签')
        all_a = BeautifulSoup(driver.page_source, 'lxml').find_all('a',title='Download photo')  #获取网页中的class为cV68d的所有a标签
        print('开始创建文件夹')
